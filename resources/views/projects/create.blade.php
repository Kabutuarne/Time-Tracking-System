                    ...
                    <form method="POST" action="{{ route('projects.store') }}"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-forms.textarea class="w-[100%]" name="description" placeholder="Required" rows="4">
                                </x-forms.textarea>
                            </div>
                        ...
                        <div class="w-full max-w-md">
                            <div>
                                <label class="block text-sm font-medium text-textcol">Add Members</label>
                                <div id="user-search"
                                    data-selected-users='@json([])'>
                                </div>
                            </div>
                        </div>
                    </form>
