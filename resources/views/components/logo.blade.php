<a href="{{ route('home') }}" class="group relative m-0 h-auto bg-transparent p-0 border-none cursor-pointer text-base tracking-[2px] uppercase font-['Arial'] text-transparent
    ...
    <span aria-hidden="true"
        class="hover-text absolute inset-0 w-0 overflow-hidden border-r-[3px] border-secondary text-secondary [-webkit-text-stroke:1px_#0CBABA] transition-all duration-300 group-hover:w-full group-hover:[filter:drop-shadow(0_0_15px_#0CBABA)]">
        &nbsp;TimeBase&nbsp;
    </span>
</a>